      ...
      for(let i = 0; i < eventos.length; i++){
        ...
        let item =
          <div className="col-lg-3" id={"evento_"+i}>
            ...
            {/*<InstagramEmbed
              url='https://www.instagram.com/p/C1A8pNBLOyJ/?igsh=bHdvdzB3dm1zNjR4'
