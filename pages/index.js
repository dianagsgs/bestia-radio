...
export default function Home(props) {
  ...
  return (
    <div>
      ...
      <Menu wallpaperFolder={props.wallpaperFolder} wallpaperCount={props.wallpaperCount}/>
      <main>
        <Script
        ...
        {modalIsActive && (
          <Modal type={modalType} ref={ref} onHideModal={hideModalHandler} wallpaperFolder={props.wallpaperFolder} wallpaperCount={props.wallpaperCount}/>
        )}
        <section
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-lg-6">
                <iframe
                  src="https://player.twitch.tv/?channel=labestiaradio&parent=labestiaradio.com&parent=www.labestiaradio.com"
                  frameBorder="0"
              ...
              <div className="col-lg-6">
                <iframe
                  src="https://www.twitch.tv/embed/labestiaradio/chat?parent=labestiaradio.com&parent=www.labestiaradio.com"
                  height="378"
                  width="100%"
                ></iframe>
              </div>
